                ...
                renderItem={product => (
                    <List.Item>
                        <Card
                            ...
                            cover={<span style={{ margin: "2.1vh 2.9vw", width: "75%", color: "#1A1A1A" }}>{product.briefDescription}</span>}
                        >
                            <Meta style={{ margin: "0 1.6vw" }}
                                description={
                                    <>
                                        <Link href={`/products/[code]`} as={`/products/${product.code}`}>
                                            <Button style={{ width: "45%" }}>Подробнее</Button>
                                        </Link>
                                        <Button type="primary" style={{ width: "45%", float: "right" }}>Участвовать</Button>
                                    </>
                                }
                            />
                        </Card>
